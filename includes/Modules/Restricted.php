		...
		return [
			'_general' => [
				...
				[
					...
					'description' => _x( 'Displays on top of the site login page. Use <code>%1$s</code> for the role, and <code>%2$s</code> for the page.', 'Modules: Restricted: Settings', GNETWORK_TEXTDOMAIN ),
				...
				[
					...
					'description' => _x( 'Displays on 403 error page for logged-in users. Use <code>%1$s</code> for the role, and <code>%2$s</code> for the page.', 'Modules: Restricted: Settings', GNETWORK_TEXTDOMAIN ),
