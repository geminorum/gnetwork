	...
	public function default_settings()
	{
		$settings = [
			'_general' => [
				[
					'field'       => 'load_defaults',
					'title'       => _x( 'Load Default Embeds', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load the default embed handlers for Audio/Video URLs or Youtube.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				],
				[
					'field'       => 'autoembed_urls',
					'title'       => _x( 'Auto-Embeds URLs', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to attempt to embed all URLs in posts and widgets.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				],
				[
					'field'       => 'oembed_providers',
					'title'       => _x( 'oEmbed Providers', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load the list of whitelisted oEmbed providers.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'after'       => Settings::fieldAfterIcon( 'https://wordpress.org/support/article/embeds/' ),
				],
				[
					'field'       => 'oembed_discover',
					'title'       => _x( 'oEmbed Discovery', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to inspect the given URL for discoverable link tags.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
			...
			'_services' => [
				[
					'field'       => 'load_docs_pdf',
					'title'       => _x( 'Load PDF Embeds', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load PDF via Google Docs embed handlers on this site.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				],
				[
					'field'       => 'load_instagram',
					'title'       => _x( 'Load Instagram Embeds', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load Instagram embed handlers on this site.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'after'       => Settings::fieldAfterIcon( 'https://www.instagram.com/developer/' ),
				],
				[
					'field'       => 'load_aparat',
					'title'       => _x( 'Load Aparat Embeds', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load Aparat.com embed handlers on this site.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'after'       => Settings::fieldAfterIcon( 'https://aparat.com' ),
				],
				[
					'field'       => 'load_balad',
					'title'       => _x( 'Load Balad Embeds', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load Balad.ir embed handlers on this site.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'after'       => Settings::fieldAfterIcon('https://balad.ir/blog/embed-balad-map/' ),
				],
				[
					'field'       => 'load_kavimo',
					'title'       => _x( 'Load Kavimo oEmbeds', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load Kavimo.com embed handlers on this site.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'after'       => Settings::fieldAfterIcon( 'https://kavimo.com' ),
				],
				[
					'field'       => 'load_giphy',
					'title'       => _x( 'Load GIPHY Embeds', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Whether to load GIPHY.com embed handlers on this site.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
		...
		if ( $this->options['load_instagram'] )
			$settings['_instagram'] = [
				[
					...
					'type'        => 'number',
					'title'       => _x( 'Image Width', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Applies as default on max width of images on Instagram embeds.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'default'     => 640,
					'min_attr'    => 320,
				],
				[
					...
					'type'        => 'disabled',
					'title'       => _x( 'Image Caption', 'Modules: Embed: Settings', 'gnetwork-admin' ),
					'description' => _x( 'Applies as default on hiding image captions on Instagram embeds.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				],
			];
		...
		$settings['_misc'] = [
			[
				'field'       => 'error_message',
				'type'        => 'text',
				'title'       => _x( 'Error Message', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				'description' => _x( 'Displays as default message upon error occurs.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				'default'     => _x( 'Error while loading the content.', 'Modules: Embed', 'gnetwork-admin' ),
			],
			[
				'field'       => 'count_channel',
				'type'        => 'number',
				'title'       => _x( 'Default Count', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				'description' => _x( 'Number of items on a list embed.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				'default'     => 10,
			],
			[
				'field'       => 'wrapped_links',
				'title'       => _x( 'Wrapped Links', 'Modules: Embed: Settings', 'gnetwork-admin' ),
				'description' => _x( 'Fixes wrapped embed links in paragraphs.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
			],
		];
	...
	public function settings_section_instagram()
	{
		Settings::fieldSection(
			...
			sprintf(
				...
				_x( 'There is no height setting because the height will adjust automatically based on the width. Instagram only allow a minimum width of %s pixels. Using a lower value will break the embed.', 'Modules: Embed: Settings', 'gnetwork-admin' ),
	...
	public function handle_aparat_channel( $matches, $attr, $url, $rawattr )
	{
		...
		if ( FALSE === ( $html = get_site_transient( $key ) ) ) {
			...
			foreach ( $rss->get_items( 0, $count ) as $item ) {
				...
				if ( empty( $title ) )
					$title = _x( 'Untitled', 'Modules: Embed: Item With No Title', 'gnetwork-admin' );
