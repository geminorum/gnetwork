...
class Embed extends gNetwork\Module
{
	...
	public function settings_section_instagram()
	{
		Settings::fieldSection(
			...
			sprintf( _x( 'There is no height setting because the height will adjust automatically based on the width. Instagram only allow a minimum width of %s pixels. Using a lower value will break the embed.', 'Modules: Embed: Settings', 'gnetwork' ), '<code>'.Number::localize( 320 ).'</code>' )
		);
	}
