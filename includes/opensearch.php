...
class gNetworkOpenSearch extends gNetworkModuleCore
{
		...
		return array(
			'_general' => array(
				array(
					...
					'type'    => 'enabled',
					'title'   => _x( 'Open Search', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'desc'    => _x( 'OpenSearch support for this blog.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'default' => '0',
				),
				array(
					'field'   => 'suggestions',
					...
					'desc'    => _x( 'OpenSearch Suggestions support for this site.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'default' => '0',
				),
				array(
					'field'   => 'shortname',
					...
					'desc'    => _x( 'A short name for the search engine. <b>16</b> chars or less, no HTML.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'default' => '',
					'class'   => 'medium-text',
				),
				array(
					...
					'desc'    => _x( 'An extended name for the search engine. <b>48</b> chars or less, no HTML.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'default' => '',
				),
				array(
					'field'   => 'description',
					...
					'desc'    => _x( 'A brief description of the search engine. <b>1024</b> chars or less, no HTML.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'default' => '',
				),
				array(
					'field'   => 'attribution',
					...
					'desc'    => _x( 'A list of all sources or entities that should be credited. <b>256</b> chars or less, no HTML.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
				...
				array(
					...
					'desc'    => _x( 'Indicates the degree to which the search results provided.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'default' => 'open',
					'values'  => array(
				...
				array(
					...
					'desc'    => _x( 'An email address at which the maintainer of the search engine can be reached.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
				...
				array(
					...
					'desc'    => _x( 'A set of words that are used as keywords to identify and categorize this search content. Single words and are delimited by space. <b>256</b> chars or less, no HTML.', 'OpenSearch Module', GNETWORK_TEXTDOMAIN ),
					'default' => '',
					'class'   => 'large-text',
				),
			),
	...
	public static function link( $text = NULL, $title = NULL, $link = NULL, $before = '', $after = '' )
	{
		...
		echo $before.gNetworkUtilities::html( 'a', array(
			'href'    => $link,
			'title'   => $title,
