...
</li>`}get_option_html({value:e,text:t}){return`<option value="${e}" selected>${t}</option>`}get_create_option_html(e){return`<li class="create-option active-result" role="option"><a>${this.create_option_text}</a> <span>${this.escape_html(e)}</span></li>`}static browser_is_supported(){return"Microsoft Internet Explorer"!==window.navigator.appName||8<=document.documentMode}}return s.default_multiple_text="Select Some Options",s.default_single_text="Select an Option",s.default_no_result_text="No results for:",s.default_create_option_text="Add Option:",s.default_remove_item_text="Remove selection",s}.call(this),(a=jQuery).fn.extend({chosen:function(i){return l.browser_is_supported()?this.each(function(e){var t=a(this),s=t.data("chosen");"destroy"===i?s instanceof h&&s.destroy():s instanceof h||t.data("chosen",new h(this,i))}):this}}),h=class extends l{setup(){return this.form_field_jq=a(this.form_field),this.current_selectedIndex=this.form_field.selectedIndex,this.scroll_throttle_timeout=null,this.scroll_handler=()=>{if(!this.scroll_throttle_timeout)return this.scroll_throttle_timeout=setTimeout(()=>(this.scroll_throttle_timeout=null,this.update_dropup_position()),16)}}set_up_html(){var e=["chosen-container"];return e.push("chosen-container-"+(this.is_multiple?"multi":"single")),this.inherit_select_classes&&this.form_field.className&&e.push(this.form_field.className),this.is_rtl&&e.push("chosen-rtl"),e={class:e.join(" "),title:this.form_field.title},this.form_field.id.length&&(e.id=this.form_field.id.replace(/[^\w]/g,"_")+"_chosen"),this.container=a("<div />",e),this.container.width(this.container_width()),this.is_multiple?this.container.html(this.get_multi_html()):this.container.html(this.get_single_html()),this.form_field_jq.css("position","absolute").css("opacity",0).css("display","none").after(this.container),this.dropdown=this.container.find("div.chosen-drop").first(),this.search_field=this.container.find("input").first(),this.search_results=this.container.find("ul.chosen-results").first(),this.search_results.attr("id",this.form_field.id+"-chosen-search-results"),this.search_groups=this.container.find("li.group-results").first(),this.search_field_scale(),this.search_no_results=this.container.find("li.no-results").first(),this.is_multiple?(this.search_choices=this.container.find("ul.chosen-choices").first(),this.search_container=this.container.find("li.search-field").first()):(this.search_container=this.container.find("div.chosen-search").first(),this.selected_item=this.container.find(".chosen-single").first()),this.set_aria_labels(),this.results_build(),this.set_tab_index(),this.set_label_behavior()}on_ready(){return this.form_field_jq.trigger("chosen:ready",{chosen:this})}register_observers(){return this.container.on("touchstart.chosen",e=>{this.container_mousedown(e)}),this.container.on("touchend.chosen",e=>{this.container_mouseup(e)}),this.container.on("mousedown.chosen",e=>{this.container_mousedown(e)}),this.container.on("mouseup.chosen",e=>{this.container_mouseup(e)}),this.container.on("mouseenter.chosen",e=>{this.mouse_enter(e)}),this.container.on("mouseleave.chosen",e=>{this.mouse_leave(e)}),this.search_groups.bind("mouseup.chosen",e=>{this.search_results_mouseup(e)}),this.search_groups.bind("mouseover.chosen",e=>{this.search_results_mouseover(e)}),this.search_groups.bind("mouseout.chosen",e=>{this.search_results_mouseout(e)}),this.search_groups.bind("mousewheel.chosen DOMMouseScroll.chosen",e=>{this.search_results_mousewheel(e)}),this.search_results.on("mouseup.chosen",e=>{this.search_results_mouseup(e)}),this.search_results.on("mouseover.chosen",e=>{this.search_results_mouseover(e)}),this.search_results.on("mouseout.chosen",e=>{this.search_results_mouseout(e)}),this.search_results.on("mousewheel.chosen DOMMouseScroll.chosen",e=>{this.search_results_mousewheel(e)}),this.search_results.on("touchstart.chosen",e=>{this.search_results_touchstart(e)}),this.search_results.on("touchmove.chosen",e=>{this.search_results_touchmove(e)}),this.search_results.on("touchend.chosen",e=>{this.search_results_touchend(e)}),this.form_field_jq.on("chosen:updated.chosen",e=>{this.results_update_field(e)}),this.form_field_jq.on("chosen:activate.chosen",e=>{this.activate_field(e)}),this.form_field_jq.on("chosen:open.chosen",e=>{this.container_mousedown(e)}),this.form_field_jq.on("chosen:close.chosen",e=>{this.close_field(e)}),this.search_field.on("blur.chosen",e=>{this.input_blur(e)}),this.search_field.on("keyup.chosen",e=>{this.keyup_checker(e)}),this.search_field.on("keydown.chosen",e=>{this.keydown_checker(e)}),this.search_field.on("focus.chosen",e=>{this.input_focus(e)}),this.search_field.on("cut.chosen",e=>{this.clipboard_event_checker(e)}),this.search_field.on("paste.chosen",e=>{this.clipboard_event_checker(e)}),this.is_multiple?this.search_choices.on("click.chosen",e=>{this.choices_click(e)}):this.container.on("click.chosen",function(e){e.preventDefault()})}destroy(){return a(null!=this.container[0].getRootNode?this.container[0].getRootNode():this.container[0].ownerDocument).off("click.chosen",this.click_test_action),0<this.form_field_label.length&&this.form_field_label.off("click.chosen"),this.results_showing&&(a(window).off("scroll.chosen",this.scroll_handler),this.scroll_throttle_timeout)&&clearTimeout(this.scroll_throttle_timeout),this.search_field[0].tabIndex&&(this.form_field_jq[0].tabIndex=this.search_field[0].tabIndex),this.container.remove(),this.form_field_jq.removeData("chosen"),this.form_field_jq.show()}set_aria_labels(){var e,t,s,i,l,h;if(this.search_field.attr("aria-owns",this.search_results.attr("id")),this.form_field.attributes["aria-label"]){if(this.search_field.attr("aria-label",this.form_field_jq.attr("aria-label")),this.form_field.attributes["aria-labelledby"])return this.search_field.attr("aria-labelledby",this.form_field_jq.attr("aria-labelledby"))}else if(Object.prototype.hasOwnProperty.call(this.form_field,"labels")&&this.form_field.labels.length){for(i="",e=t=0,l=(h=this.form_field.labels).length;t<l;e=++t)""===(s=h[e]).id&&(s.id=this.form_field.id+"-chosen-label-"+e),i+=this.form_field.labels[e].id+" ";return this.search_field.attr("aria-labelledby",i)}}search_field_disabled(){return this.is_disabled=this.form_field.disabled||this.form_field_jq.parents("fieldset").is(":disabled"),this.container.toggleClass("chosen-disabled",this.is_disabled),this.search_field[0].disabled=this.is_disabled,this.is_multiple||this.selected_item.off("focus.chosen",this.activate_field),this.is_disabled?this.close_field():this.is_multiple?void 0:this.selected_item.on("focus.chosen",this.activate_field)}container_mousedown(e){var t;if(!this.is_disabled)return e&&"left"===this.mousedown_checker(e)&&e&&"mousedown"===e.type&&!this.results_showing&&e.preventDefault(),!e||"mousedown"!==(t=e.type)&&"touchstart"!==t||this.results_showing||e.preventDefault(),null!=e&&a(e.target).hasClass("search-choice-close")?void 0:(this.active_field?this.is_multiple||!e||a(e.target)[0]!==this.selected_item[0]&&!a(e.target).parents("a.chosen-single").length||(e.preventDefault(),this.results_toggle()):(this.is_multiple&&this.search_field.val(""),a(null!=this.container[0].getRootNode?this.container[0].getRootNode():this.container[0].ownerDocument).on("click.chosen",this.click_test_action),this.results_show()),this.activate_field())}container_mouseup(e){if(!this.is_disabled&&this.allow_single_deselect&&a(e.target).hasClass("search-choice-close"))return this.results_reset(e)}search_results_mousewheel(e){var t;if(null!=(t=e.originalEvent?e.originalEvent.deltaY||-e.originalEvent.wheelDelta||e.originalEvent.detail:t))return e.preventDefault(),"DOMMouseScroll"===e.type&&(t*=40),this.search_results.scrollTop(t+this.search_results.scrollTop())}blur_test(e){if(!this.active_field&&this.container.hasClass("chosen-container-active"))return this.close_field()}close_field(){return a(null!=this.container[0].getRootNode?this.container[0].getRootNode():this.container[0].ownerDocument).off("click.chosen",this.click_test_action),this.active_field=!1,this.results_hide(),this.search_field.attr("aria-expanded",!1),this.container.removeClass("chosen-container-active"),this.container.removeClass("chosen-dropup"),this.clear_backstroke(),this.show_search_field_default(),this.search_field_scale(),this.search_field.trigger("blur")}should_dropup(){var e=a(window).height(),t=this.container.offset().top+this.container.height()-a(window).scrollTop();return e<this.dropdown.height()+t}update_dropup_position(){if(this.results_showing)return this.should_dropup()?this.container.addClass("chosen-dropup"):this.container.removeClass("chosen-dropup")}activate_field(){if(!this.is_disabled)return this.container.addClass("chosen-container-active"),this.should_dropup()&&this.container.addClass("chosen-dropup"),this.active_field=!0,this.search_field.val(this.search_field.val()),this.search_results.attr("aria-busy",!1),this.search_field.trigger("focus")}test_active_click(e){var t=a(e.target).closest(".chosen-container");return"left"===this.mousedown_checker(e)&&t.length&&this.container[0]===t[0]?this.active_field=!0:this.close_field()}results_build(){return this.parsing=!0,this.selected_option_count=null,this.results_data=o.select_to_array(this.form_field,this.parser_config),this.is_multiple?this.search_choices.find("li.search-choice").remove():(this.single_set_selected_text(),this.disable_search||this.form_field.options.length<=this.disable_search_threshold&&!this.create_option?(this.search_field[0].readOnly=!0,this.container.addClass("chosen-container-single-nosearch")):(this.search_field[0].readOnly=!1,this.container.removeClass("chosen-container-single-nosearch"))),this.update_results_content(this.results_option_build({first:!0})),this.search_field_disabled(),this.show_search_field_default(),this.search_field_scale(),this.parsing=!1}result_do_highlight(e){var t,s,i;if(e.length)return this.result_clear_highlight(),this.result_highlight=e,this.result_highlight.addClass("highlighted"),this.search_field.attr("aria-activedescendant",this.result_highlight.attr("id")),(e=parseInt(this.search_results.css("maxHeight"),10))+(i=this.search_results.scrollTop())<=(t=(s=this.result_highlight.position().top+this.search_results.scrollTop())+this.result_highlight.outerHeight())?this.search_results.scrollTop(0<t-e?t-e:0):s<i?this.search_results.scrollTop(s):void 0}result_clear_highlight(){return this.result_highlight&&this.result_highlight.removeClass("highlighted"),this.result_highlight=null}results_show(){return this.is_multiple&&this.max_selected_options<=this.choices_count()?(this.form_field_jq.trigger("chosen:maxselected",{chosen:this}),!1):(this.should_dropup()&&this.container.addClass("chosen-dropup"),this.container.addClass("chosen-with-drop"),this.container.find(".chosen-single div").attr("aria-label","Hide options"),this.results_showing=!0,this.search_field.attr("aria-expanded",!0),this.search_field.trigger("focus"),this.search_field.val(this.get_search_field_value()),this.winnow_results(),this.form_field_jq.trigger("chosen:showing_dropdown",{chosen:this}),a(window).on("scroll.chosen",this.scroll_handler))}update_results_content(e){return this.search_results.html(e)}fire_search_updated(e){return this.form_field_jq.trigger("chosen:search_updated",{chosen:this,search_term:e})}results_hide(){if(this.results_showing&&(this.result_clear_highlight(),this.container.removeClass("chosen-with-drop"),this.container.removeClass("chosen-dropup"),this.container.find(".chosen-single div").attr("aria-label","Show options"),this.form_field_jq.trigger("chosen:hiding_dropdown",{chosen:this})),this.search_field.attr("aria-expanded",!1),this.results_showing=!1,a(window).off("scroll.chosen",this.scroll_handler),this.scroll_throttle_timeout)return clearTimeout(this.scroll_throttle_timeout)}set_tab_index(e){var t;if(this.form_field.tabIndex)return t=this.form_field.tabIndex,this.form_field.tabIndex=-1,this.search_field[0].tabIndex=t}set_label_behavior(){if(this.form_field_label=this.form_field_jq.parents("label"),!this.form_field_label.length&&this.form_field.id.length&&(this.form_field_label=a(`label[for='${this.form_field.id}']`)),0<this.form_field_label.length)return this.form_field_label.on("click.chosen",this.label_click_handler)}set_search_field_placeholder(){return this.is_multiple&&this.choices_count()<1?this.search_field.attr("placeholder",this.default_text):this.search_field.attr("placeholder","")}show_search_field_default(){return this.search_field.val(""),this.set_search_field_placeholder(),this.is_multiple&&this.choices_count()<1&&!this.active_field?this.search_field.addClass("default"):this.search_field.removeClass("default")}search_results_mouseup(e){var t;if("left"===this.mousedown_checker(e)&&(t=a(e.target).is(".active-result,.group-result")?a(e.target):a(e.target).parents(".active-result").first()).length)return this.result_highlight=t,this.result_select(e),this.search_field.focus()}search_results_mouseover(e){e=a(e.target).hasClass("active-result")?a(e.target):a(e.target).parents(".active-result").first();if(e)return this.result_do_highlight(e)}search_results_mouseout(e){if(a(e.target).hasClass("active-result")||a(e.target).parents(".active-result").first())return this.result_clear_highlight()}choice_build(e){var t,s=a("<li />",{class:"search-choice","data-value":e.value,role:"option"}).html(`<span>${this.choice_label(e)}</span>`);return e.disabled?s.addClass("search-choice-disabled"):((t=a("<button />",{type:"button",tabindex:-1,class:"search-choice-close","data-option-array-index":e.data["data-option-array-index"]}).html('<span class="visually-hidden focusable">'+l.default_remove_item_text+"</span>")).on("click.chosen",e=>this.choice_destroy_link_click(e)),s.append(t)),this.inherit_option_classes&&e.classes&&s[0].classList.add(e.classes),this.search_container.before(s)}choice_destroy_link_click(e){if(e.preventDefault(),e.stopPropagation(),!this.is_disabled)return this.choice_destroy(a(e.target))}choice_destroy(e){if(this.result_deselect(e[0].getAttribute("data-option-array-index")))return this.active_field?this.search_field.trigger("focus"):this.show_search_field_default(),this.is_multiple&&this.hide_results_on_select&&0<this.choices_count()&&this.get_search_field_value().length<1&&this.results_hide(),e.parents("li").first().remove(),this.set_search_field_placeholder(),this.search_field_scale()}results_reset(){if(this.reset_single_select_options(),this.form_field.options[0].selected=!0,this.single_set_selected_text(),this.show_search_field_default(),this.results_reset_cleanup(),this.trigger_form_field_change(),this.active_field)return this.results_hide()}results_reset_cleanup(){return this.current_selectedIndex=this.form_field.selectedIndex,this.selected_item.find(".search-choice-close").remove()}result_select(l){var e;return a(l.target).hasClass("group-result")?this.can_select_by_group?void a(l.target).nextAll().each((e,t)=>{var s,i;return!a(t).hasClass("group-result")&&(s=a(t).attr("data-option-array-index"),i=!1,a("#pops_chosen > .chosen-choices").find(".search-choice-close").each((e,t)=>{if(a(t).attr("data-option-array-index")===s)return!(i=!0)}),i?void 0:(this.result_highlight=a(t),l.target=t,l.selected=!0,this.result_select(l)))}):void 0:this.result_highlight?(e=this.result_highlight).hasClass("create-option")?(this.select_create_option(this.search_field.val()),this.results_hide()):(this.result_clear_highlight(),this.is_multiple&&this.max_selected_options<=this.choices_count()?(this.form_field_jq.trigger("chosen:maxselected",{chosen:this}),!1):(this.is_multiple?e.removeClass("active-result"):this.reset_single_select_options(),e.addClass("result-selected"),(e=this.results_data[e[0].getAttribute("data-option-array-index")]).selected=!0,this.form_field.options[e.options_index].selected=!0,this.selected_option_count=null,this.is_multiple?this.choice_build(e):this.single_set_selected_text(this.choice_label(e)),this.is_multiple&&(!this.hide_results_on_select||l.metaKey||l.ctrlKey)?l.metaKey||l.ctrlKey?this.winnow_results({skip_highlight:!0}):(this.search_field.val(""),this.winnow_results()):(this.results_hide(),this.show_search_field_default()),!this.is_multiple&&this.form_field.selectedIndex===this.current_selectedIndex||this.trigger_form_field_change({selected:this.form_field.options[e.options_index].value}),this.current_selectedIndex=this.form_field.selectedIndex,l.preventDefault(),this.search_field_scale())):void 0}single_set_selected_text(e=this.default_text){return e===this.default_text?(this.selected_item.addClass("chosen-default"),e=this.escape_html(e)):(this.single_deselect_control_build(),this.selected_item.removeClass("chosen-default")),this.selected_item.find("span").html(e)}result_deselect(e){e=this.results_data[e];return!this.form_field.options[e.options_index].disabled&&(e.selected=!1,this.form_field.options[e.options_index].selected=!1,this.selected_option_count=null,this.result_clear_highlight(),this.results_showing&&this.winnow_results(),this.trigger_form_field_change({deselected:this.form_field.options[e.options_index].value}),this.search_field_scale(),!0)}single_deselect_control_build(){if(this.allow_single_deselect)return this.selected_item.find(".search-choice-close").length||this.selected_item.find("span").first().after('<button type="button" tabindex="-1" class="search-choice-close"></button>'),this.selected_item.addClass("chosen-single-with-deselect")}get_search_field_value(){return this.search_field.val()}get_search_text(){return a.trim(this.get_search_field_value())}escape_html(e){return a("<div/>").text(e).html()}unescape_html(e){return e.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#039;/g,"'").replace(/&#x27;/g,"'")}winnow_results_set_highlight(){var e=this.is_multiple?[]:this.search_results.find(".result-selected.active-result"),e=(e.length?e:this.search_results.find(".active-result")).first();if(null!=e)return this.result_do_highlight(e)}no_results(e){e=this.get_no_results_html(e);return this.search_results.append(e),this.form_field_jq.trigger("chosen:no_results",{chosen:this})}show_create_option(e){e=this.get_create_option_html(e);return this.search_results.append(e)}create_option_clear(){return this.search_results.find(".create-option").remove()}select_create_option(e){return a.isFunction(this.create_option)?this.create_option.call(this,e):this.select_append_option({value:e,text:e})}select_append_option(e){e=this.get_option_html(e);return this.form_field_jq.append(e),this.form_field_jq.trigger("chosen:updated"),this.form_field_jq.trigger("change"),this.search_field.trigger("focus")}no_results_clear(){return this.search_results.find(".no-results").remove()}keydown_arrow(){var e;return this.results_showing&&this.result_highlight?(e=this.result_highlight.nextAll("li.active-result").first())?this.result_do_highlight(e):void 0:this.results_showing&&this.create_option?this.result_do_highlight(this.search_results.find(".create-option")):this.results_show()}keyup_arrow(){var e;return this.results_showing||this.is_multiple?this.result_highlight?(e=this.result_highlight.prevAll("li.active-result")).length?this.result_do_highlight(e.first()):(0<this.choices_count()&&this.results_hide(),this.result_clear_highlight()):void 0:this.results_show()}keydown_backstroke(){var e;return this.pending_backstroke?(this.choice_destroy(this.pending_backstroke.find(".search-choice-close").first()),this.clear_backstroke()):(e=this.search_container.siblings("li.search-choice").last()).length&&!e.hasClass("search-choice-disabled")?(this.pending_backstroke=e,this.single_backstroke_delete?this.keydown_backstroke():this.pending_backstroke.addClass("search-choice-focus")):void 0}clear_backstroke(){return this.pending_backstroke&&this.pending_backstroke.removeClass("search-choice-focus"),this.pending_backstroke=null}search_field_scale(){var e,t,s,i,l,h,r;if(this.is_multiple){for(l={position:"absolute",left:"-1000px",top:"-1000px",display:"none",whiteSpace:"pre"},t=0,s=(h=["fontSize","fontStyle","fontWeight","fontFamily","lineHeight","textTransform","letterSpacing"]).length;t<s;t++)l[i=h[t]]=this.search_field.css(i);return(e=a("<div />").css(l)).text(this.get_search_field_value()||this.search_field.attr("placeholder")),a("body").append(e),r=e.width()+25,e.remove(),this.container.is(":visible")&&(r=Math.min(this.container.outerWidth()-10,r)),this.search_field.width(r)}}trigger_form_field_change(e){return this.form_field_jq.trigger("input",e),this.form_field_jq.trigger("change",e)}}}.call(this);