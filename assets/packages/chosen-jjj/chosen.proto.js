  ...
  AbstractChosen = (function() {
    class AbstractChosen {
      ...
      set_default_values() {
        ...
        return this.max_search_length = this.options.max_search_length || 1000;
      }
      ...
      winnow_results(options) {
        var escaped_query, exact_regex, exact_result, fix, highlight_regex, i, j, k, l, len, match_length, match_value, matched_length_in_normalized, normalized_query, normalized_text, option, prefix, prefix_normalized, query, ref, ref1, ref2, ref3, regex, results, results_group, search_match, startpos, substr_normalized, suffix, text;
